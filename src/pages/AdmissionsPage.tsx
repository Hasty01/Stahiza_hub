...
export const AdmissionsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-gold selection:text-black">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 px-4 bg-muted/20 overflow-hidden">
        {/* Hero Background Image */}
        <div className="absolute inset-0 -z-10">
          <img 
            src="https://picsum.photos/seed/students-campus/1920/1080" 
            alt="Students on Campus" 
            className="w-full h-full object-cover opacity-10 grayscale-[0.3]"
