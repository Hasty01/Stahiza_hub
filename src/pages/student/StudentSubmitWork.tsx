        ...
        <Card className="rounded-[3rem] p-10 border-2">
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="space-y-4">
              ...
              <div className="relative">
                <select className="flex h-14 w-full rounded-2xl border-2 border-border bg-card-bg px-6 py-2 text-sm font-bold focus:outline-none focus:border-gold appearance-none transition-all cursor-pointer">
                  <option>Physics: Newton's Laws</option>
                  <option>Mathematics: Calculus Basics</option>
